package com.example.appbansach.ultil;

public class Server {
    public static String localhost = "192.168.1.27:8080";
    ...
    public static String Duongdantruyen = "http://" + localhost + "/server/getsanpham.php?page=";
