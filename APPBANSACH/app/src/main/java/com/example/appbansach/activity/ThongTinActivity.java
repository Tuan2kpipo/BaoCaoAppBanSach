...
public class ThongTinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng ictu = new LatLng(21.585070, 105.806426);
        mMap.addMarker(new MarkerOptions().position(ictu).title("Trường đại học CNTT và TT Thái Nguyên").snippet("ictu nè").icon(BitmapDescriptorFactory.defaultMarker()));
        mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        CameraPosition cameraPosition = new CameraPosition.Builder().target(ictu).zoom(90).build();
